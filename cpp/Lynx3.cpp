...
const std::vector<int> neighbours[107] = {{},{4,3,2},{5,6,3,1},{1,2,6,7,8,4},{9,8,3,1},{10,11,6,2},{2,3,7,12,11,5},{3,6,12,13,14,8},{3,4,9,15,14,7},{4,8,15,16},{5,11,18,17},{19,18,10,5,6,12},{19,20,13,7,6,11},{21,20,12,7,14,22},{23,22,13,7,8,15},
		...
		for(int i : edge) {
			if(isSet(l, r, i)) {	// Did we play this move?
				...
				while(top != 0) {
					...
					for(int j = 0; j < (int)neighbours[current].size(); j++) {
